...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/res/left_arrow2.png"), QSize(), QIcon::Normal, QIcon::Off);
        pgupToolButton2->setIcon(icon2);
        ...
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/res/left_arrow.png"), QSize(), QIcon::Normal, QIcon::Off);
        pgupToolButton1->setIcon(icon3);
        ...
        QIcon icon4;
        icon4.addFile(QStringLiteral(":/res/right_arrow.png"), QSize(), QIcon::Normal, QIcon::Off);
        pgdownToolButton1->setIcon(icon4);
        ...
        QIcon icon5;
        icon5.addFile(QStringLiteral(":/res/right_arrow2.png"), QSize(), QIcon::Normal, QIcon::Off);
        pgdownToolButton2->setIcon(icon5);
        ...
        QIcon icon6;
        icon6.addFile(QStringLiteral(":/res/favorite.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon7;
        icon7.addFile(QStringLiteral(":/res/web.png"), QSize(), QIcon::Normal, QIcon::Off);
        netdictButton->setIcon(icon7);
        ...
        QIcon icon8;
        icon8.addFile(QStringLiteral(":/res/search.png"), QSize(), QIcon::Normal, QIcon::Off);
        queryButton->setIcon(icon8);
...
" } "));
        ...
        QIcon icon9;
        icon9.addFile(QStringLiteral(":/res/down.png"), QSize(), QIcon::Normal, QIcon::Off);
        dictDownToolButton->setIcon(icon9);
        ...
        QIcon icon10;
        icon10.addFile(QStringLiteral(":/res/up.png"), QSize(), QIcon::Normal, QIcon::Off);
        dictUpToolButton->setIcon(icon10);
